...
int main(void)
{
  ...
  //printf("Contorl LED via UART DMA\r\n");
  //printf("%s",menu_cmd);
    ...
    /* USER CODE BEGIN 3 */
	  if(cmdstate){
	      	...
	      	case '7':
	      		...
	      		send_uart_dma(uart_buffer, strlen((char*)uart_buffer));
	      		break;
	         ...
	         if((blinkstatus == 1)&&(HAL_GetTick()-blinktimer>2000)){
	      		   if(led_status){
	      			   led_status=0;
	      		   }
	      		   else{
	         ...
	         if((blinkstatus == 2)&&(HAL_GetTick()-blinktimer>1000)){
	         	      		   if(led_status){
	         	      			   led_status=0;
	         	      		   }
	         	      		   else{
	         ...
	         if((blinkstatus == 3)&&(HAL_GetTick()-blinktimer>500)){
	         	      		   if(led_status){
	         	      			   led_status=0;
	         	      		   }
	         	      		   else{
	         ...
	         HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, led_status);
  }
  /* USER CODE END 3 */
}
